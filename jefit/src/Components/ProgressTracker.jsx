            ...
            <div className="container">
                <div className="row" style={{display:"flex"}}>
                    <div className="col-md-6">
                        <div className="container">
                            <img className="img-fluid" src="https://www.jefit.com/wp/wp-content/uploads/2022/08/web3.png" alt=""style={{width:"70%"}} />
                        </div>
                    </div>
                    <div className="col-md-6" style={{marginRight:"70px",width:"80%"}}>
                        <h6 className='font Cchange' style={{fontSize:"20px"}}>WORKOUT TRACKING</h6>
