                ...
                <div className="container"  >
                    ...
                    <div className="container">
                        <div className="row" style={{display:"flex"}}>
                            <div className="col-md-6" style={{textAlign: 'justify',width:"80%",marginLeft:"160px"}}>
                                <h6 className='heading' style={{fontSize:"20px"}}>WORKOUT TRACKING</h6>
                                <h2 className='heading' style={{fontSize:"50px"}}> <b>TRAIN & LOG SEAMLESSLY IN GYM AND HOME</b></h2>  
                            ...
                            <div className="col-md-6">
                                <div className="container">
                                    <img className="img-fluid" src="https://www.jefit.com/wp/wp-content/uploads/2022/08/web2.png" alt="" style={{width:"70%",marginTop:"100px"}} />
                                </div>
                            </div>
                        </div>
                    </div>
